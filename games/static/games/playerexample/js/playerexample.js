...
async function loadRessources() {
    SHEET = await PIXI.Assets.load('../../static/games/playerexample/res/player/player.json');
    bg1 = await PIXI.Assets.load("../../static/games/playerexample/res/background/background1.png");
    bg2 = await PIXI.Assets.load("../../static/games/playerexample/res/background/background2.png");
    bg3 = await PIXI.Assets.load("../../static/games/playerexample/res/background/background3.png");
    createSprites();
}

...
let background = PIXI.Sprite.from("res/textures/background.jpg");
...
for (let i = 1; i <= 3; i++) {
    groundbreakSprites.push(PIXI.Texture.from("res/textures/groundbreak"+i+".png"));
}
...
const enemySprite = PIXI.Texture.from("res/textures/enemy.png");
